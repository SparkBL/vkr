\subsection{\centering RQ--система с входящим MMPP и двумерным выходящим потоком} \label{section_map_twodim}
...
\subsubsection{\centering Переход к явному распределению вероятностей}
