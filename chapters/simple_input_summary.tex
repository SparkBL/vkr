\subsection{RQ--система с суммарным выходящим потоком} \label{section_simple_summary}
...
\begin{theorem}
	...
	\begin{equation*} \label{theorem_summary}
		\begin{split}
			\boldsymbol{F}(u_,t) =  \lim_{\sigma \xrightarrow{} 0} M\{\exp(jum(t))\} &= \lim_{\epsilon \xrightarrow{} 0} \sum_{k=0}^{2}F_{k}(0,u,t,\epsilon) = \boldsymbol{R} \cdot \exp\{G(u)t\} \cdot \boldsymbol{E},
		\end{split}
	\end{equation*}
	где 
	\begin{equation*}
