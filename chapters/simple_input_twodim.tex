\subsection{\centering RQ--система с двумерным выходящим потоком} \label{section_simple_twodim}
...
\subsubsection{\centering Уравнения Колмогорова}
...
\subsubsection{\centering Метод асимптотического анализа}
...
\subsubsection{\centering Переход к явному распределению вероятностей} \label{distr_find_twodim}
...
\subsubsection{\centering Коэффициент корреляции} \label{corr_section}
